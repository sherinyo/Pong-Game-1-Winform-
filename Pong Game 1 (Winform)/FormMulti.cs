    ...
    public partial class FormMulti : Form
    {
        ...
        private void pongTimer_Tick(object sender, EventArgs e) // every 20 ms what happen maka code inside will run, utk detect apakah bola kluar arena dsb
        {
            ...
            if (pongBall.Left + pongBall.Width > ClientSize.Width) //+ pongBall.Width agar saat bola nyentuh sisi kanan maka terhitung score, klo gada maka bola ndelep ke kanan bru score
            {
                ...
                if (cpuScore < 5) // to make the ball faster after respawn, +2 krn respawn ke kiri
                {
                    ballXCoordinate += 1;
                }
            ...
            if (playerScore >= 10)
            {
                ...
                Form player1W = new player1WinMulti();
                player1W.Owner = this;      
            ...
            else if (cpuScore >= 10)
            {
                ...
                Form player2W = new player2WinMulti();
                player2W.Owner = this;              
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.L)
            {
                Form court = new ChooseCourtMulti();
                court.Owner = this;
                pongTimer.Stop();
                court.Show();
            }
            ...
            {
                pongTimer.Stop();
                Form feature = new PauseOptionMulti();
                feature.Owner = this;
                feature.Show();
            }
        }
